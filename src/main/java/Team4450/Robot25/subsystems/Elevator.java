...
import static Team4450.Robot25.Constants.ELEVATOR_MOTOR_LEFT;
import static Team4450.Robot25.Constants.ELEVATOR_MOTOR_RIGHT;
...
public class Elevator extends SubsystemBase {
    private SparkMax motorMain = new SparkMax(ELEVATOR_MOTOR_LEFT, MotorType.kBrushless);
    private SparkMax motorFollower = new SparkMax(ELEVATOR_MOTOR_RIGHT, MotorType.kBrushless);
    ...
    public Elevator() {
        ...
        followerConfig.follow(motorMain, true);
